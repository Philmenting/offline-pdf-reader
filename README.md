...
- Batch-Rename für Ordner mit Dry-Run-Tabellenvorschau (Altname/Neuer Name/Confidence/Quelle/Grund), farblicher Confidence-Markierung, Konflikt-Policy (`(1)`, `(2)` oder überspringen) und optional „nur sichere Vorschläge“
